...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        HashPlusToken = 44,
        HashMinusToken = 45,
        HashAsteriskToken = 46,
        PercentToken = 47,
        PlusPlusToken = 48,
        MinusMinusToken = 49,
        LessThanLessThanToken = 50,
        GreaterThanGreaterThanToken = 51,
        GreaterThanGreaterThanGreaterThanToken = 52,
        AmpersandToken = 53,
        BarToken = 54,
        CaretToken = 55,
        ExclamationToken = 56,
        ...
        PlusEqualsToken = 67,
        MinusEqualsToken = 68,
        AsteriskEqualsToken = 69,
        AsteriskAsteriskEqualsToken = 70,
        SlashEqualsToken = 71,
        PercentEqualsToken = 72,
        LessThanLessThanEqualsToken = 73,
        GreaterThanGreaterThanEqualsToken = 74,
        GreaterThanGreaterThanGreaterThanEqualsToken = 75,
        AmpersandEqualsToken = 76,
        BarEqualsToken = 77,
        BarBarEqualsToken = 78,
        AmpersandAmpersandEqualsToken = 79,
        QuestionQuestionEqualsToken = 80,
        CaretEqualsToken = 81,
        Identifier = 82,
        ...
        FirstAssignment = 66,
        LastAssignment = 81,
        FirstCompoundAssignment = 67,
        LastCompoundAssignment = 81,
    ...
    export type PunctuationSyntaxKind = SyntaxKind.OpenBraceToken | SyntaxKind.CloseBraceToken | SyntaxKind.OpenParenToken | SyntaxKind.CloseParenToken | SyntaxKind.OpenBracketToken | SyntaxKind.CloseBracketToken | SyntaxKind.DotToken | SyntaxKind.DotDotDotToken | SyntaxKind.SemicolonToken | SyntaxKind.CommaToken | SyntaxKind.QuestionDotToken | SyntaxKind.LessThanToken | SyntaxKind.LessThanSlashToken | SyntaxKind.GreaterThanToken | SyntaxKind.LessThanEqualsToken | SyntaxKind.GreaterThanEqualsToken | SyntaxKind.EqualsEqualsToken | SyntaxKind.ExclamationEqualsToken | SyntaxKind.EqualsEqualsEqualsToken | SyntaxKind.ExclamationEqualsEqualsToken | SyntaxKind.EqualsGreaterThanToken | SyntaxKind.PlusToken | SyntaxKind.MinusToken | SyntaxKind.AsteriskToken | SyntaxKind.AsteriskAsteriskToken | SyntaxKind.SlashToken | SyntaxKind.HashPlusToken | SyntaxKind.HashMinusToken | SyntaxKind.HashAsteriskToken | SyntaxKind.PercentToken | SyntaxKind.PlusPlusToken | SyntaxKind.MinusMinusToken | SyntaxKind.LessThanLessThanToken | SyntaxKind.GreaterThanGreaterThanToken | SyntaxKind.GreaterThanGreaterThanGreaterThanToken | SyntaxKind.AmpersandToken | SyntaxKind.BarToken | SyntaxKind.CaretToken | SyntaxKind.ExclamationToken | SyntaxKind.TildeToken | SyntaxKind.AmpersandAmpersandToken | SyntaxKind.BarBarToken | SyntaxKind.QuestionQuestionToken | SyntaxKind.QuestionToken | SyntaxKind.ColonToken | SyntaxKind.AtToken | SyntaxKind.BacktickToken | SyntaxKind.HashToken | SyntaxKind.EqualsToken | SyntaxKind.PlusEqualsToken | SyntaxKind.MinusEqualsToken | SyntaxKind.AsteriskEqualsToken | SyntaxKind.AsteriskAsteriskEqualsToken | SyntaxKind.SlashEqualsToken | SyntaxKind.PercentEqualsToken | SyntaxKind.LessThanLessThanEqualsToken | SyntaxKind.GreaterThanGreaterThanEqualsToken | SyntaxKind.GreaterThanGreaterThanGreaterThanEqualsToken | SyntaxKind.AmpersandEqualsToken | SyntaxKind.BarEqualsToken | SyntaxKind.CaretEqualsToken;
    ...
    export type MultiplicativeOperator = SyntaxKind.AsteriskToken | SyntaxKind.SlashToken | SyntaxKind.PercentToken | SyntaxKind.HashAsteriskToken;
    export type MultiplicativeOperatorOrHigher = ExponentiationOperator | MultiplicativeOperator;
    export type AdditiveOperator = SyntaxKind.PlusToken | SyntaxKind.MinusToken | SyntaxKind.HashPlusToken | SyntaxKind.HashMinusToken;
